								...
								<div className="card-action card-tabs mt-3 mt-sm-0">
									<Nav as="ul" className="nav nav-tabs" role="tablist">
										<Nav.Item as="li" className="nav-item">
											<Nav.Link as="a" className="nav-link c-pointer" data-toggle="tab" eventKey="Theme"> Theme </Nav.Link>
										</Nav.Item>
										<Nav.Item as="li" className="nav-item">
											<Nav.Link as="a" className="nav-link c-pointer" data-toggle="tab" eventKey="Header"> Header </Nav.Link>
										</Nav.Item>
										<Nav.Item as="li" className="nav-item">
											<Nav.Link as="a" className="nav-link c-pointer"  data-toggle="tab" eventKey="Content" >Content</Nav.Link>
										</Nav.Item>
									</Nav>
								</div>
		...
		<div className={`dz-demo-panel ${demoToggle ? "show" : ""}`}>
			...
			<div className="dz-demo-inner">
				...
				<div className="fs-12 pt-3">
					...
					<Link to={"https://ventic.dexignzone.com/react/doc"}  className="text-primary"> documentation.</Link>
				</div>
			</div>
		</div>
	</>
