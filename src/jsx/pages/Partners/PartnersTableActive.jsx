    ...
    const Partners_GET = async () => {
        try {
            ...
            if (res.status === 200 && res.data.responseCode === 1 && res.data.error) {
               await Swal.fire({ icon: 'error', title: res.data.message });
            } else if (res.status === 200 && res.data.responseCode === 1 && res.data.warning) {
               await Swal.fire({ icon: 'warning', title: res.data.message });
            ...
            <div>
                ...
                <div className="card">
                    <div className="card-header">
                        <h4 style={{color:'green'}} className="card-title">Active Partners</h4>

                        <button
                            onClick={() => exportToExcel('ActivePartners')}
                        ...
                        {partners ? (
                            partners.length > 0 ? (
                                <div className="table-responsive">
                                    <table id="ActivePartners" {...getTableProps()} className="table dataTable display">
                                        <thead>
...
export default PartnersTableActive;
